...
$(PROG) : $(OBJS) 
	$(CC) $(CFLAGS) $(OBJS) -o $(PROG)
		mv $(PROG) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS1) -o $(PROG1)
		mv $(PROG1) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS2) -o $(PROG2)
		mv $(PROG2) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS3) -o $(PROG3)
		mv $(PROG3) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS4) -o $(PROG4)
		mv $(PROG4) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS5) -o $(PROG5)
		mv $(PROG5) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS6) -o $(PROG6)
		mv $(PROG6) $(prefix)
	$(CC) $(CFLAGS) $(SCRS8) $(SCRS7) -o $(PROG7)
		mv $(PROG7) $(prefix)
#----------------------------------
